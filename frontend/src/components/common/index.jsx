...
// ─── Status Badge ─────────────────────────────────────────────
// Solid filled pill style — white text on colored background,
// matching the design in the screenshot. 100% inline styles to
// prevent Bootstrap's .badge global rule from overriding anything.
const BADGE_STYLES = {
...
// ─── Modal ────────────────────────────────────────────────────
// FIX: inline styles only — Bootstrap .modal { display:none } was hiding
// our modal and its fixed overlay was blocking all page click events.
...
// ─── Confirm Modal ────────────────────────────────────────────
// FIX: same Bootstrap conflict fix as Modal above — inline styles only.
