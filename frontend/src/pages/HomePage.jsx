  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/accounts/newsletter/subscribe/`,
        {
          method: "POST",
      ...
      if (response.ok) {
        ...
        // Backend returns field errors like { email: ["...msg..."] }
        // or generic errors like { detail: "..." } or { message: "..." }
        const errorMsg =
        ...
        <section className="py-20 bg-[#E8DCC4] text-center">
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[#A6754D] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#8D5F3B] transition"
              >
                Subscribe
              </button>
            </form>
