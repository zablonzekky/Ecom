...
function CartPage() {
  ...
  const handleCheckout = () => {
    // ✅ Check both user context AND token in storage
    // This covers regular users, Google, and Facebook social logins
    const token =
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100 sticky top-24">
                ...
                >
                  {/* ✅ Button label accounts for all auth types */}
                  {user || localStorage.getItem("access_token") || sessionStorage.getItem("access_token")
                    ? "Proceed to Checkout"
                    : "Login to Checkout"}
                </button>
                ...
                <div className="mt-6 pt-6 border-t space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <span>M-PESA & PayPal payments</span>
                  </div>
                </div>
              </div>
            </div>
